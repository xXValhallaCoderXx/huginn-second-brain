...
- **Personality Management:** CRUD for SOUL.md and IDENTITY.md files with versioning
- **Channel Management:** Link/unlink Telegram accounts via QR codes
- **Calendar Integration:** OAuth connections to Google Calendar with encrypted token storage
